...
var countdownDate = "2014/04/26"; // Enter your countdown date

var locationTitle = "Accenture Hack: Battle of the Bay"; // Enter your event title
var locationAddress = "2211 North 1st Street, CA 95131"; // Enter your event address

var twitterWidgetId = "439572821501440000"; // Enter your twitter widgetId
...
// Judges
//-------------------------------------------------------------------------------
$(".judge").mouseover(function(){
  $(this).addClass("active");
});

$(".judge").mouseout(function(){
  $(this).removeClass("active");
});
